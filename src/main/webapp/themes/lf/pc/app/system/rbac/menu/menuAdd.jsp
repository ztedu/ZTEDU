            ...
            <div class="layui-form-item">
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-inline">
                  ...
                  <div class="layui-input-inline">
                    <input type="text" name="icon" autocomplete="off" placeholder="请输入菜单图片"
                           class="layui-input">
                  </div>
                </div>
              </div>
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                  <input type="text" name="target" autocomplete="off" placeholder="请输入菜单目标"
                         class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
        ...
        success: function (data) {
          if (data.ret) {
            layer.msg('菜单添加成功', {
              ...
              window.parent.addedNewMenu = data.data;
            });
          } else {
