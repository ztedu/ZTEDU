 ...
 * @Title:        ZTEDU
 * @Description   TODO
 * @Company:      https://fly.layui.com/extend/treeSelect/
 *
 * @Author        LYQ
 * @CreateDate    2019/3/26 20:26
 */
...
function(c,a,b,f){(!a||!d.isHidden(c,a))&&s.apply(e,arguments)};var t=e.repairParentChkClassWithSelf;if(t)e.repairParentChkClassWithSelf=function(c,a){(!a||!d.isHidden(c,a))&&t.apply(e,arguments)}})(jQuery);
  ...
  var deleteEmptyProperty = function deleteEmptyProperty(object) {
    for (var i in object) {
      var value = object[i];
